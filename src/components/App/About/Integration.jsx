  ...
  return (
    <div className="integration pt-60" data-scroll-index="3">
      ...
      <div className="section-head text-center style-4 animate-fadeUp">
        <h2 className="mb-20">
          {'Integración con tus'} <span>{'aplicaciones'}</span>
        </h2>
        <p className="animate-fadeUp" style={{ transitionDelay: '150ms' }}>
          {'Integramos tus aplicaciones con plataformas seguras y reconocidas'}
        </p>
      </div>
