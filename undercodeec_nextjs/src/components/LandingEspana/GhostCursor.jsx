...
/**
 * GhostCursor – fluid, smoky cursor trail effect using Three.js shaders +
 * post-processing bloom. Parent must be position:relative; canvas is absolute
...
export const GhostCursor = ({
  ...
  return (
    <div
      ref={containerRef}
      className={`ghost-cursor-canvas ${className ?? ""}`.trim()}
      style={{
        position: "absolute",
        inset: 0,
        pointerEvents: "none",
