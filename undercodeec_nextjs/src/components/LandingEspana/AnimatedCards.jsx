...
const CARD_COPY = [
  {
    title: "Understudio",
    desc: "Estudio creativo de Under Codeec para experiencias web, motion UI y productos digitales con identidad visual propia.",
    href: "https://understudio.undercodeec.com",
  },
  {
    title: "Demo-Moon",
    desc: "Modelo lunar 3D en miniatura para mostrar profundidad, movimiento y presencia visual dentro del card.",
    model: "moon",
  },
  {
    title: "Interaccion visual",
    desc: "Cards con volumen, video y respuesta al movimiento para presentar ideas con impacto.",
  },
  {
    title: "Narrativa digital",
    desc: "Capas visuales que ayudan a explicar productos, servicios y demos de forma memorable.",
  },
  {
    title: "Motion UI",
    desc: "Microinteracciones y composiciones animadas listas para integrarse en una landing.",
  },
];
    ...
    >
      ...
      >
        {Array.from({ length: cardCount }).map((_, i) => {
          const copy = CARD_COPY[i % CARD_COPY.length];
          const CardShell = copy.href ? "a" : "div";
          ...
          return (
            <CardShell
              ...
              href={copy.href}
              target={copy.href ? "_blank" : undefined}
              rel={copy.href ? "noopener noreferrer" : undefined}
              style={{
                position: "absolute",
                inset: 0,
                width: `${CARD_W}px`,
                ...
                transformStyle: "preserve-3d",
                textDecoration: "none",
                cursor: copy.href ? "pointer" : "default",
              }}
            >
                ...
                return (
                  ...
                  >
                    <video
                      ...
                      muted
                      playsInline
                      style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", borderRadius: "14px", opacity: copy.model === "moon" ? 0.34 : 0.72 }}
                    />
                    <div style={{ position: "absolute", inset: 0, padding: "20px", background: "linear-gradient(180deg, rgba(255,255,255,0.18) 0%, rgba(255,255,255,0.72) 58%, rgba(255,255,255,0.96) 100%)", zIndex: 10 }}>
                      {/* Chip */}
                      ...
                      {copy.model === "moon" && (
                        <div
                          ...
                          style={{
                            ...
                            borderRadius: "14px",
                            overflow: "hidden",
                            background: "radial-gradient(circle, rgba(96,11,86,0.18), rgba(21,14,35,0.08) 60%, rgba(255,255,255,0.12))",
                            boxShadow: "inset 0 0 0 1px rgba(21,14,35,0.1), 0 12px 28px rgba(21,14,35,0.18)",
                          }}
                        >
                          <MoonMini />
                        </div>
                      )}
                      <div style={{ position: "absolute", left: "18px", right: "18px", bottom: "16px", zIndex: 15 }}>
                        <div style={{ color: "#150e23", fontSize: "16px", fontWeight: 800, lineHeight: 1.1, marginBottom: "4px" }}>
                          {copy.title}
                        </div>
                        <p style={cardTextStyle}>{copy.desc}</p>
                      </div>
                      {/* JWT logo top-right */}
                      <div style={{ position: "absolute", right: "18px", top: "16px", opacity: copy.model === "moon" ? 0 : 0.72 }}>
